...
namespace Serialization_and_Deserialization
{
    ...
    public class SoapSerialization
    {
        static void CallSerialization()
        {
            ...
            obj.Print();
            Stream stream = File.Open(@"F:\Bizruntime\Workspace\Serialization\UserRecord.xml", FileMode.Create);
        ...
        static void CallDeSerialization()
        {
            ...
            try
            {
                stream = File.Open(@"F:\Bizruntime\Workspace\Serialization\UserRecord.xml", FileMode.Open);
                SoapFormatter formatter = new SoapFormatter();
